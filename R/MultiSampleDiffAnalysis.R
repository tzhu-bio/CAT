...
#' Title A function to quantify tissue-specificity as the Specificity Measure (SPM).
#'
#' @param quant_data A normalized data obtained by **quantification**.
...
#' Title   getTopSpecifcPeaks
#'
#' @param spm_data The Specificity Measure(SPM) result obtained by **calSPM**.
#' @param norm_data A normalized data obtained by **quantification**.
#' @param top_N The top N specific peaks to return.
...
#' Title A function to calculate the JSD score.
#'
#' @param norm_data A normalized data obtained by **quantification**.
...
#' Title   A function to identify sample specific peaks.
#'
#' @param norm_data A normalized data obtained by **quantification**.
#' @param jsd_file The JSD result obtained by **calJSD**.
#' @param cutoff The JSD cutoff to determine the sample specific peaks.
...
#' @param zscore_min The maximum value of the zscore.
#' @param zscore_max The minium value of the zscore.
#' @param cluster_col Wheather to cluster columns.
#' @param color Heatmap color.
#' @param save_path The path to save the sample specific peak pdf file.
#' @param file_prefix The save file prefix.
#' @param figure_height The PDF height.
#' @param figure_width The PDF width.
#'
#' @return
#' @export
#'
...
#' Title  A function to help you determine the cluster number before you use **plotClusterSpecificPeak**.
#'
#' @param specific_peak A sample specific peak file obtained by **getSpecificPeak**.
#'
#' @return
...
#' Title   A function to help you plot the sample specific peaks with heatmap.
#'
#' @param specific_peak A sample specific peak file obtained by **getSpecificPeak**.
#' @param zscore_min The maximum value of the zscore.
#' @param zscore_max The minium value of the zscore.
#' @param cluster_num The cluster number obtained by **getClusterNum**.
#' @param cluster_col Wheather to clustering columns.
...
#' Title   A function to find the target genes based on specific peaks.
#'
#' @param cluster_group A cluster group cluster file obtained by **plotClusterSpecificPeak**.
#' @param save_path  The path to save the sample specific peak pdf file.
#' @param file_prefix  The save file prefix.
#' @param tss_file  The TSS coordinates file.
#'
#' @return
#' @export
#'
...
#' Title   A function to plot the every cluster target genes GO enrichment.
#'
#' @param target The target genes result obtained by **getClusterTargetGenes**.
#' @param orgdb The orgdb annotation package name.
#' @param N_top The top N GO terms showing in the plot.
#' @param scale_size The max and min value of dot size. e.g. scale_size = c(2,7).
#' @param ont The GO type to enrich. Three type are available: "BP", "CC", "MP". Default is BP.
#' @param clustering Whether to clutsering the GO terms. Default is TRUE.
#'
#' @return
#' @export
#'
...
#' Title   A function to compare the GO enrichment result with Network.
#'
#' @param target  The target genes result obtained by **getClusterTargetGenes**.
#' @param orgdb    The orgdb annotation package name.
#' @param ont  The GO type to enrich. Three type are available: "BP", "CC", "MP". Default is BP.
#' @param showCategory  The max category number to show. Default is 50.
#' @param category_node  The size of category nodes. Default is 0.5.
#' @param line  The width of the line. Default is 0.5.
#' @param category_labelThe size of category label. Default is 1.2.
#'
#' @return
#' @export
#'
