...
#' @param plot_type Option to draw ridges / density plot.
#'
#' @return
#' @export
#'
...
#' @param figure_height PDF figure height
#' @param figure_width  PDF figure width
#'
#' @return
#' @export
#'
...
#' Title  A function used to plot tree clustering result
#'
#' @param norm_data The normalized data obtained by **quantification**
