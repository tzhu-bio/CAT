...
#' Title  Order the rows along with psedotime
#'
#' @param mat
#'
#' @return
...
#' Title   Plot the RNA dynamic along the pseudotime.
#'
...
#' @param return_matrix Wheather to return the result as data frame.
#'
#' @return
#' @export
#'
