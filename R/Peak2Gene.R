...
#'                       If you set 20000, it will find the peak-to-gene within 20kb upstream and downstream of the gene.
#' @param N_permutation Simulate how many times pseudo-data to measure the P value of each peak-to-gene.
...
#' @param fig_width The PDF width.
#' @param fig_height The PDF height.
#'
#' @return
#' @export
#'
...
#' @param peak The peaks coordinate you want to plot.
...
#' @param cor_cutoff The correlation cutoff of peak-to-gene linkages..  Default is 0.4.
#' @param line_size The curve line with.  Default is 0.8.
#' @param curvature The degree of curvature. Default is 0.3.
#' @param color Color list to plot tracks.
#' @param back.colorWhether to plot backgroud color.  Default if TRUE.
#'
#' @return
#' @export
#'
