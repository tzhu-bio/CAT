#' Title A function help us look for which genes these SNPs might affect the expression of.
#'
#' @param snp The SNP coordinates file.
#' @param peak2gene Peak2Gene result obtained by **getPeak2Gene**.
#' @param corr_cutoff Pearson's correlation coefficient threshold for determining significance Peak2Gene links.
#'
#' @return
#' @export
#'
