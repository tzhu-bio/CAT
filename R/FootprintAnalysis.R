...
#' Title  A function to get the footprint score.
#'
#' @param samples  The sample list to get the footprint score.
#'
...
#' Title  A function to plot all samples footprint with scatter / heatmap.
#'
#' @param score_result The footprint score result obtained by **getFootprintScore**.
#' @param cluster_N The cluster number for heatmap. Default is 6.
#' @param label_motif The motif list to label in the right of the heatmap.
#' @param limit_Zscore Whether to limit zscore to -2 to 2. Default is FALSE.
#'
#' @return
#' @export
#'
