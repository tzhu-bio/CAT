#' Title  A function to identify the differential peaks between two groups.
#'
#' @param norm_data The normalizated data use **quantification**.
#' @param condition Your samples two conditions, like the control and experiment.
...
#' Title A function to plot the differential result.
#'
...
#' @param figure_height The PDF figure height.
#' @param figure_width The PDF figure width.
#'
#' @return
#' @export
#'
...
#' Title A function to call the differential peak target genes.
#'
#' @param diff_data The differential data obtained by **getDiffPeak**.
...
#' Title  A fucntion to plot MA plot
#'
...
#' Title A function to compare the chromatin accessibility across thress samples.
#'
