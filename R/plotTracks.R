...
#' @param coaccess_cutoff The correlation cutoff of co-accessible.  Default is 0.4.
...
#' @param left  Left flanking.
#' @param right Right flanking.
#'
#' @return
#' @export
#'
...
#' @param samples_suffix The suffix of the samples.
#' @param gene_name The gene name.
#' @param left The gene left flanking to plot. Default is 30000.
#' @param right The gene right flanking to plot. Default is 30000.
#' @param peaks The merged peaks.
