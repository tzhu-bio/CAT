#' Title  A function to calculate the two group peaks enrichment based on Fisher Test.
#'
#' @param peak_a  The peak sets A you want to enrich with peak B.
#' @param peak_b The peak sets B you want to enrich with peak A.
...
#' Title  A function to plot the enrichment rsult based on **calFisherPeaks**.
#'
