...
#' Title A function to add the necessary annotation for **CAT**.
#'
#' @param gene_bed The bed file for genes.
...
#' Title  A function to add necessary annotation for foorprinting analysis.
#'
