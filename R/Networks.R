...
#' @param p2g_cutoff  The absolute cutoff of peak2gene correlation. Default is 0.5.
#' @param motif2gene The annotation file obtained by **getMotif2Gene**.
#' @param targets The target only contain TF(1) or contain genes and TFs (2). Default is 1.
#' @param level Consider only the target genes of your TF of interest (1). Consider not only the target genes of your TF of interest, but also more downstream target genes (2). Default is 2.
#'
#' @return
#' @export
#'
