## https://www.pnas.org/doi/10.1073/pnas.2215328119
#' Title
#'
#' @param sample_list A vectot contains sample names.
#' @param peak_path The path contains the sample peak files.
#' @param peak_suffix The suffix of peak files.
#' @param N_top The top number of peakset return.
#' @param blacklist A blacklist would prevent us from identifying super enhancers in those areas.
#'
#' @return
#' @export
#'
